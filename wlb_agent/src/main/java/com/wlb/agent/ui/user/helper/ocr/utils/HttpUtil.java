...
public class HttpUtil {
    ...
    // 访问服务器地址
    public static String ENGINE_URL = "https://www.yunmaiocr.com/SrvXMLAPI";
...
//        if (LContext.isDebug) {
//            //测试账号
//            USERNAME = "84653ec2-5ab9-4952-8144-d6429a6297f5";// 开发者平台API帐号
//            PASSWORD = "oWWklddDkkDHoLxNIxkyGASxLAWCgf";// 开发者平台API密码
//        } else {
        //正式账号
        USERNAME = "a4929096-a8a2-4379-9bb2-b6542dbe8b82";// 开发者平台API帐号
        PASSWORD = "dxQlDVgjMWjkMbcUcVrHbJeSsdlvRL";// 开发者平台API密码
//        }
    }
...
//        file = new byte[]{0, 1};
        ...
        LogUtil.d("NetClient", "行驶证提交post===="+ENGINE_URL + requestString);
        try {
