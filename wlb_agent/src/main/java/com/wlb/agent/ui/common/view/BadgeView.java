...
public class BadgeView extends AppCompatTextView {
    ...
    private float mTextSizeSp = 10;//文字大小sp单位
    ...
    private void init() {
        ...
        setBackground(10, Color.RED);//Color.parseColor("#d3321b")
    ...
    public void setBadgeCount(int count) {
        if (count < 10) {
            setPadding(DeviceUtil.dip2px(getContext(), mTextSizeSp / 2), DeviceUtil.dip2px(getContext(), 1),
                    DeviceUtil.dip2px(getContext(), mTextSizeSp / 2), DeviceUtil.dip2px(getContext(), 1));
        } else {
            setPadding(DeviceUtil.dip2px(getContext(), 2), DeviceUtil.dip2px(getContext(), 1),
                    DeviceUtil.dip2px(getContext(), 2), DeviceUtil.dip2px(getContext(), 1));
        }
