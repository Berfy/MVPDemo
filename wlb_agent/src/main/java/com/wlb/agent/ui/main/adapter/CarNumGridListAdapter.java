 ...
 * @author Berfy
 */
public class CarNumGridListAdapter extends ListAdapter<String> {
    ...
    public CarNumGridListAdapter(Context context, int margin, int spaceWidth, int numColumns, int maxLineHeight) {
        super(context, null, R.layout.adapter_car_number_list_item);
        mMargin = margin;
